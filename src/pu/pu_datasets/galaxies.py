"""
Dataset adapter for HCVYM5w6Gn/galaxies (v2.0).
...
Usage with the v2.0 revision which includes metadata columns directly:
    galaxies = load_dataset("HCVYM5w6Gn/galaxies", revision="v2.0", streaming=True)
"""
...
# These are the columns from HCVYM5w6Gn/galaxies_metadata that ship with v2.0.
METADATA_COLUMNS = [
    "dr8_id",
    # Morphology
...
class GalaxiesAdapter(DatasetAdapter):
    """Adapter for HCVYM5w6Gn/galaxies v2.0 with bundled metadata."""
