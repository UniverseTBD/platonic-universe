...
# Maps physics parameter name → dataset column name for HCVYM5w6Gn/cosmosweb-hsc-jwst-high-snr-pil2.
CATALOG_COLUMNS = {
...
class CosmosWebAdapter(DatasetAdapter):
    """Adapter for HCVYM5w6Gn/cosmosweb-hsc-jwst-high-snr-pil2.
