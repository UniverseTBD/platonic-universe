...
def main():
    ...
    parser_layerwise.add_argument("--metrics", nargs="+", default=["mknn", "cka", "rsa", "pwcca", "linear_r2"], help="Metrics to compute.")
    ...
    parser_convergence.add_argument("--metrics", nargs="+", default=["mknn", "cka", "rsa", "pwcca", "linear_r2"], help="Metrics to compute.")
