...
def compute_percentiles(max_samples=10000, resize_mode="match", output_path="data/percentiles.json"):
    ...
    ds = (
        load_dataset("HCVYM5w6Gn/legacysurvey_hsc_crossmatched", split="train", streaming=True)
    ...
    ds = (
        load_dataset("HCVYM5w6Gn/jwst_hsc_crossmatched", split="train", streaming=True)
